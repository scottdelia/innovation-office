  ...
  return (
    <article className="card flex flex-col overflow-hidden transition-colors hover:border-line-strong">
      ...
      {bet.status === 'shipped' && headline && (
        <dl className="mx-5 mb-4 grid grid-cols-2 gap-px overflow-hidden rounded-lg border border-line bg-line">
          <div className="bg-surface-inset px-3.5 py-3">
            <dt className="text-[0.6875rem] uppercase tracking-[0.06em] text-ink-faint">
              {headline.name}
            </dt>
          ...
          {weakest && (
            <div className="bg-surface-inset px-3.5 py-3">
              <dt className="text-[0.6875rem] uppercase tracking-[0.06em] text-warn">
                {weakest.name}
              </dt>
              <dd className="tabular mt-1 text-base font-semibold text-ink">
                {weakest.value}
      ...
      {bet.status === 'scoped' && bet.killCriterion && (
        ...
        >
          <p className="text-[0.6875rem] font-semibold uppercase tracking-[0.06em] text-ink-faint">
            Kill criterion, registered before building
          </p>
